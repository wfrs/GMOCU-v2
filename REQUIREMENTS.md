# GMOCU-v2 Product Requirements

## Product Vision

A modern, user-friendly desktop application for managing plasmid documentation and GMO compliance in academic research labs. Designed for researchers of all technical levels, from bachelor students to lab managers.
...
- **Plasmid composition**
  - Tag which features are in each plasmid
...
### Local Database
```
Location: ~/GMOCU/data/gmocu.db (SQLite)
Contents:
